...
import com.jindanupajit.bullhorn.jedi.util.Verbose;
...
public class Info {
    ...
    public String typeOf(Object o) {
        String type = typeResolver(o, o.getClass());
        ...
        for(Method method : o.getClass().getDeclaredMethods()){
            ...
            try {
                ...
                if (Modifier.isPublic(method.getModifiers())) {
                    FieldInfo fieldInfo = new FieldInfo(fieldName, typeResolver(type));

                    // JPA
                    fieldInfo.setId(field.isAnnotationPresent(Id.class));
                    fieldInfo.setId(field.isAnnotationPresent(NaturalId.class));
                    ...
                    if (field.isAnnotationPresent(UserInput.class)) {
                        ...
                        fieldInfo.setIgnored(userInput.ignored());
                    }
    ...
    private String typeResolver(Class cls) {
        return typeResolver(null, cls);
    }
    private String typeResolver(Object obj, Class cls) {
